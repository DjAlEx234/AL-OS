...
cfc
i686-elf-gcc -c ../Commands/main.c -o main.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I"../Headers/"
cfc
...
afc
i686-elf-gcc -T ../Boot-Loader/link.ld -o ../AL-OS.bin -I"../Headers/" -ffreestanding -O2 -nostdlib entry.o entry2.o asm-io.o interrupt.o interrupt2.o terminal.o keyboard.o main.o
